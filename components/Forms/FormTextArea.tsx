...
function FormTextArea({ labelProps, label, containerProps, textAreaProps }: FormTextAreaProps) {
  ...
  return (
    <Flex flex='1' alignItems='center' borderBottom={`2px solid ${white}`}  w='100%' {...containerProps}>
        ...
        <Textarea pt='1.1rem' resize='none' rows={3} fontSize='1.4rem' border='none' outline='none'  _focus={{ border: 'none', boxShadow: 'none'}} flex='0.9'  {...textAreaProps}  />
    </Flex>
  )
}
