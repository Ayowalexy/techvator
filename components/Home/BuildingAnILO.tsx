...
function BuildingAnILO() {
  ...
  return (
    <Container
      ...
      position="relative"
      bgSize="500px"
      bgImage='url("/imgs/home/Mdwaba-Homeimage@2x.png")'
      bgRepeat="no-repeat"
      bgPos="100% 40%"
    >
      <Flex>
        ...
        >
          ...
          <Box my="3rem">
            <Text fontSize={{ base: "1.4rem", lg: "1.8rem" }} lineHeight="2">
              "It is my expressed desire to contribute to building an ILO that
              systimatically demonstrates its cares for all staff and
              constituents , and works to effectively deliver on commitments to
              ensure the dignity of everyone involved in the world of work"
            </Text>
          </Box>
